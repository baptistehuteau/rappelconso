...
""):
    st.info("Description : La listeria est un infection microbienne dûe à l ingestion de denrées alimentaires contaminée par la bactérie Listeria monocytogène." / 
            "Celle-ci se développe à rapidement à température ambiante mais est inhibée lorsqu elle est exposée à des températures faibles comme au frigo. Le seul moyen de détruire la bactérie est de faire cuire l'aliment à haute température au four ou à la poele." /
            "Symptômes : " /
"- forme digestive avec douleur abdominale, diharrée et symptôme grippale" /
